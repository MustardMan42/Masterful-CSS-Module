  const MODULE_ID = "masterful-css-module"; //Change this to the lowercase id at the top of your module.json
  ...
  var cssId = 'myCss'; //I adapted this code from Reddit user u/lady_of_luck, without their post none of my exploration into this topic would have been possible
     if (!document.getElementById(cssId))
     {
       ...
       link.rel  = 'stylesheet';
       link.type = 'text/css';
       link.href = 'modules/masterful-css-module/styles/mustardman42-tutorial.css'; //Put file path here!
       link.media = 'all';
